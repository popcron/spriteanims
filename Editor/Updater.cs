...
public class Updater : Editor
{
    ...
    private const string PackageName = "com.popcron.spriteanims";
    private const string PackageURL = "https://raw.githubusercontent.com/popcron/spriteanims/master/package.json";
    private const string CanUpdateKey = "Popcron.Animations.CanUpdate";
    private const string CheckForUpdateText = "Popcron/Animations/Check for updates";
    private const string UpdateText = "Popcron/Animations/Update";
